...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        UILabel *lbl=[[UILabel alloc]initWithFrame:CGRectMake1(0, 0, 55, 29)];
        ...
        self.lbl1=[[UILabel alloc]initWithFrame:CGRectMake1(60, 0, 200, 29)];
        ...
        lbl=[[UILabel alloc]initWithFrame:CGRectMake1(0, 29, 55, 29)];
        [lbl setFont:[UIFont systemFontOfSize:12]];
        [lbl setTextColor:[UIColor colorWithRed:(102/255.0) green:(102/255.0) blue:(102/255.0) alpha:1]];
        [lbl setTextAlignment:NSTextAlignmentRight];
        [lbl setText:@"站点:"];
        ...
        self.lbl2=[[UILabel alloc]initWithFrame:CGRectMake1(60, 29, 140, 29)];
        ...
        lbl=[[UILabel alloc]initWithFrame:CGRectMake1(180, 29, 55, 29)];
        [lbl setFont:[UIFont systemFontOfSize:12]];
        [lbl setTextColor:[UIColor colorWithRed:(102/255.0) green:(102/255.0) blue:(102/255.0) alpha:1]];
        [lbl setTextAlignment:NSTextAlignmentRight];
        [lbl setText:@"报警分类:"];
        ...
        self.lbl3=[[UILabel alloc]initWithFrame:CGRectMake1(240, 29, 60, 29)];
        ...
        lbl=[[UILabel alloc]initWithFrame:CGRectMake1(0, 58, 55, 29)];
        [lbl setFont:[UIFont systemFontOfSize:12]];
        [lbl setTextColor:[UIColor colorWithRed:(102/255.0) green:(102/255.0) blue:(102/255.0) alpha:1]];
        [lbl setTextAlignment:NSTextAlignmentRight];
        [lbl setText:@"线路名称:"];
        ...
        self.lbl4=[[UILabel alloc]initWithFrame:CGRectMake1(60, 58, 200, 29)];
        ...
        lbl=[[UILabel alloc]initWithFrame:CGRectMake1(0, 87, 55, 49)];
        [lbl setFont:[UIFont systemFontOfSize:12]];
        [lbl setTextColor:[UIColor colorWithRed:(102/255.0) green:(102/255.0) blue:(102/255.0) alpha:1]];
        [lbl setTextAlignment:NSTextAlignmentRight];
        [lbl setText:@"报警内容:"];
        ...
        self.lbl5=[[UILabel alloc]initWithFrame:CGRectMake1(60, 87, 250, 49)];
