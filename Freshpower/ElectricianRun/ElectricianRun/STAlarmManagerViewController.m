...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(refreshed:) name:Notification_TabClick_STAlarmManagerViewController object:nil];
...
- (void)search:(id)sender {
    STAlarmManagerSearchViewController *alarmManagerSearchViewController=[[STAlarmManagerSearchViewController alloc]initWithData:searchData];
