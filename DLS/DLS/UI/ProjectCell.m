...
- (void)setData:(NSDictionary *)data
{
    ...
    self.address.text=[NSString stringWithFormat:@"设备地址:%@",address];
    self.money.text=[NSString stringWithFormat:@"备注:%@",notes];
    [self.date setText:CreateDate];
