...
- (void)loadData{
    ...
    [p setObject:[[User Instance]getUserName] forKey:@"imei"];
    [p setObject:[[User Instance]getPassword] forKey:@"authentication"];
    [p setObject:[[User Instance]getCPNameId] forKey:@"CP_ID"];
    ...
    [self.hRequest handle:URL_AppHisMeterElec requestParams:p];
}
